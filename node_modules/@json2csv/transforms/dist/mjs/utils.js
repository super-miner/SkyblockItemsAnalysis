...
export function setProp(obj, path, value) {
    ...
    return Object.assign(Object.assign({}, obj), { [key]: pathArray.length > 1
...
export function unsetProp(obj, path) {
    ...
    if (pathArray.length === 1) {
        return Object.keys(obj)
            ...
            .reduce((acc, prop) => (Object.assign(Object.assign({}, acc), { [prop]: obj[prop] })), {});
    }
    return Object.keys(obj).reduce((acc, prop) => (Object.assign(Object.assign({}, acc), { [prop]: prop !== key
            ? obj[prop]
            : unsetProp(obj[key], restPath) })), {});
}
