...
export declare function setProp<T extends object, PT>(obj: T, path: PropertyPath, value: PT): T;
export declare function unsetProp<T extends object>(obj: T, path: PropertyPath): T;
